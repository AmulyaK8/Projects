...
initial_position_.x = rospy.get_param(0)
initial_position_.y = rospy.get_param(100)
initial_position_.z = 0
desired_position_ = Point()
desired_position_.x = rospy.get_param(0)
desired_position_.y = rospy.get_param(90)
